<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li @click="menu=1"><a class="app-menu__item" href="#"><i class="app-menu__icon icon fa fa-wrench"></i><span class="app-menu__label">Mantenimiento</span></a></li>
        ...
        <li @click="menu=13"><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-info"></i><span class="app-menu__label"> Acerca de...</span></a></li>
        </li>
       </ul>
    </aside>